...
import AddStocks from "@/components/Modals/Stocks/Add";
...
function StockProducts() {
	...
	const {
		...
		["stockProducts", "stocktransfers", startDate, endDate],
		generateUrlWithParams("stocktransfers", {
			docDateStart: String(startDate),
			docDateEnd: String(endDate),
			documentStatus: "O",
